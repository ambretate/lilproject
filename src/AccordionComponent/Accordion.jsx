...
function Accordion({ times }) {
  const accordionData = [
    {
      time: times.results.astronomical_twilight_begin,
    ...
    {
      time: times.results.nautical_twilight_begin,
    ...
    {
      time: times.results.civil_twilight_begin,
    ...
    {
      time: times.results.nautical_twilight_end,
    ...
    {
      time: times.results.astronomical_twilight_end,
